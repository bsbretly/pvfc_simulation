...
up_ramp_normal_gain, up_ramp_tangent_gain = 5., 1.
p1, p2 = [0.5,0.], [2.5,.25] # two points (x,z) on the ramp [m]
...
plane_params = namedtuple('plane_params', ['plane_k', 'plane_mu'], defaults=(plane_k, plane_mu))
ramp_params = namedtuple('ramp_params', ['p1', 'p2', 'ramp_k', 'ramp_mu'], defaults=(p1, p2, ramp_k, ramp_mu))
